...
public class NameGenerator {
    ...
    public static String getName(SocialClass type, Gender gender) {
        ...
        switch (gender) {
            case MALE:
                family = samuraiFamilyNames[r.nextInt(NameGenerator.samuraiFamilyNames.length)];
                given = samuraiMaleGivenNames[r.nextInt(NameGenerator.samuraiMaleGivenNames.length)];
                break;

            case FEMALE:
                family = samuraiFamilyNames[r.nextInt(NameGenerator.samuraiFamilyNames.length)];
                given = femaleGivenNames[r.nextInt(NameGenerator.femaleGivenNames.length)];
                break;
        }
    ...
    */
    ...
    static String[] samuraiMaleGivenNames =
    ...
    static String[] femaleGivenNames = {
            "Acha",
            "Achacha",
            "Ai",
            "Aki",
